...
class ActivityListNotifier extends _$ActivityListNotifier {
  ...
  Future<void> createActivity({
    ...
    try {
      ...
      ref
          ...
          .showSuccessWithAutoClear('Activity created successfully!');
    } catch (error) {
      final appError = _handleActivityError(error);
      ref.read(errorNotifierProvider.notifier).showError(appError);
      rethrow;
  ...
  Future<void> updateActivity(Activity activity) async {
    try {
      ...
      ref
          .read(successNotifierProvider.notifier)
          .showSuccessWithAutoClear('Activity updated successfully!');
    } catch (error) {
      final appError = _handleActivityError(error);
      ref.read(errorNotifierProvider.notifier).showError(appError);
      rethrow;
  ...
  Future<void> deleteActivity(String activityId) async {
    try {
      ...
      ref
          .read(successNotifierProvider.notifier)
          .showSuccessWithAutoClear('Activity deleted successfully!');
    } catch (error) {
      final appError = _handleActivityError(error);
      ref.read(errorNotifierProvider.notifier).showError(appError);
      rethrow;
  ...
  Future<void> assignActivityToDay(String activityId, String day, int dayOrder,
    ...
    try {
      ...
      ref
          .read(successNotifierProvider.notifier)
          .showSuccessWithAutoClear('Activity assigned to day successfully!');
    } catch (error) {
      final appError = _handleActivityError(error);
      ref.read(errorNotifierProvider.notifier).showError(appError);
      rethrow;
  ...
  Future<void> moveActivityToPool(String activityId) async {
    try {
      ...
      ref
          .read(successNotifierProvider.notifier)
          .showSuccessWithAutoClear('Activity moved to pool successfully!');
    } catch (error) {
      final appError = _handleActivityError(error);
      ref.read(errorNotifierProvider.notifier).showError(appError);
      rethrow;
  ...
  Future<void> reorderActivitiesInDay(
      String day, List<Activity> reorderedActivities) async {
    try {
      final activityRepository = ref.read(activityRepositoryProvider);

      // Separate timed and untimed activities
      final timedActivities =
          reorderedActivities.where((a) => a.timeSlot != null).toList();
      final untimedActivities =
          reorderedActivities.where((a) => a.timeSlot == null).toList();
      ...
      ref
          .read(successNotifierProvider.notifier)
          .showSuccessWithAutoClear('Activities reordered successfully!');
    } catch (error) {
      final appError = _handleActivityError(error);
      ref.read(errorNotifierProvider.notifier).showError(appError);
      rethrow;
  ...
  Future<void> updateActivityTimeSlot(
      String activityId, String? timeSlot) async {
    try {
      final activityRepository = ref.read(activityRepositoryProvider);
      final activity = await activityRepository.getActivityById(activityId);
      ...
      ref
          .read(successNotifierProvider.notifier)
          .showSuccessWithAutoClear('Time slot updated successfully!');
    } catch (error) {
      final appError = _handleActivityError(error);
      ref.read(errorNotifierProvider.notifier).showError(appError);
      rethrow;
  ...
  Future<void> moveActivityBetweenDays(
      String activityId, String? fromDay, String toDay, int newOrder) async {
    try {
      final activityRepository = ref.read(activityRepositoryProvider);
      final activity = await activityRepository.getActivityById(activityId);
      ...
      ref
          .read(successNotifierProvider.notifier)
          .showSuccessWithAutoClear('Activity moved successfully!');
    } catch (error) {
      final appError = _handleActivityError(error);
      ref.read(errorNotifierProvider.notifier).showError(appError);
      rethrow;
  ...
  Future<void> addBrainstormIdea(String activityId, String description) async {
    try {
      ...
      ref
          .read(successNotifierProvider.notifier)
          .showSuccessWithAutoClear('Brainstorm idea added successfully!');
    } catch (error) {
      final appError = _handleActivityError(error);
      ref.read(errorNotifierProvider.notifier).showError(appError);
      rethrow;
  ...
  Future<void> removeBrainstormIdea(String activityId, String ideaId) async {
    try {
      ...
      ref
          .read(successNotifierProvider.notifier)
          .showSuccessWithAutoClear('Brainstorm idea removed successfully!');
    } catch (error) {
      final appError = _handleActivityError(error);
      ref.read(errorNotifierProvider.notifier).showError(appError);
      rethrow;
  ...
  Future<void> reorderBrainstormIdeas(
    ...
    try {
      ...
      ref
          .read(successNotifierProvider.notifier)
          .showSuccessWithAutoClear('Brainstorm ideas reordered successfully!');
    } catch (error) {
      final appError = _handleActivityError(error);
      ref.read(errorNotifierProvider.notifier).showError(appError);
      rethrow;
  ...
  AppError _handleActivityError(Object error) {
    if (error.toString().contains('network')) {
      return const AppError.network(
          'Network error while managing activities. Please check your connection.');
    } else if (error.toString().contains('permission')) {
      return const AppError.permission(
          'You do not have permission to perform this action.');
    } else if (error.toString().contains('not found')) {
      return const AppError.validation(
          'Activity not found or no longer exists.');
    } else {
      return const AppError.unknown(
          'An error occurred while managing activities. Please try again.');
    }
  }
}
...
class ActivityGroupsNotifier extends _$ActivityGroupsNotifier {
  ...
  Future<ActivityGroups> build(String tripId) async {
    final activities =
        await ref.watch(activityListNotifierProvider(tripId).future);
